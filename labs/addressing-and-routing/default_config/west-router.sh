#!/bin/sh
# Starter config for west-router. It configures nothing, and that is the point: this lab
...
# learner has configured and puts the router back where it started.
#
# Interface(s) on this router: 108-WEST 108-MID
set -e

for IF in 108-WEST 108-MID; do
