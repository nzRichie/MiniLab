#!/bin/sh
# Starter config for east-router. It configures nothing, and that is the point: this lab
...
#
# Interface(s) on this router: 108-MID 108-EAST
set -e

for IF in 108-MID 108-EAST; do
