...
#
# Scoped to the six containers named in lib.sh plus the wiring helper. It must
...
removed=0
for ctn in "$ROOT_CTN" "$PRIMARY_CTN" "$SECONDARY_CTN" "$SUB_CTN" "$CLIENT_CTN" "$SW_CTN" "$HELPER_CTN"; do
