...
# on one of them.
#
# The four target hosts are named for their number and not for the service each
# runs, because this list is on screen and finding out what runs where is the
# graded exercise.
#
...
ROLES="attacker router host1 host2 host3 host4"
